var config = {
    ...
    chapters: [

        {
            ...
            hidden: false,
            title: '',
            description: 'Scroll to see the heat level of each HOLC grade, where <span style="color: red";>red</span> is hotter and <span style="color: blue";>blue</span> is cooler.',
            location: {
