var config = {
    ...
    chapters: [

        {
            ...
            hidden: false,
            title: '',
            description: 'Scroll to see the heat level of each HOLC grade, where <span style="color: red";>#bf3641</span> is hotter and <span style="color: #0F4971";>blue</span> is cooler.',
            location: {
